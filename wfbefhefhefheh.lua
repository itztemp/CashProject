...
local MovementSpeeds = {
	HeliSpeed = (LRM_IsUserPremium and 5000 or 700),
	VehicleSpeed = 650,
	FlightSpeed = (LRM_IsUserPremium and 175 or 150),
	PathSpeed = (LRM_IsUserPremium and 180 or 45)
}
...
task.spawn(function()
	local Messages = {
        ...
        ",gg/bHWwjTnq2c -> Join for daily giveaways!",
